...
initial_resource_filename = "./input_files/Resources-waste 0.75.xlsx"
initial_interventions_filename = "./input_files/Interventions_case0.xlsx"


# Game Output Files
output_schedule_filename = "./output_files/raw-waste 0.75.txt"  # Output - Print for each search best EU and path.

game_state_print = True  # Print game state ?
game_state_filename = "./game_output_files/raw-waste 0.75.csv"  # Game State Delta State Quality outputs
